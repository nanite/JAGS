...
public class LangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(JAGSRegistry.FAKE_GRASS_BLOCK_ITEM.get(), "Fake Grass Block");
        ...
        for (Map.Entry<JAGSRegistry.FakeGrassType, RegistryEntry.ItemEntry<Item>> value : JAGSRegistry.FAKE_GRASS_BLOCK_ITEMS.entrySet()) {
